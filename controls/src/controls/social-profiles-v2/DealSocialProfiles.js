...
export default function SocialProfiles({
  ...
  const onProfileClick = (icon) => {
    ...
    let newProfiles = [...profiles];
    let newUrl = url;
    let newLinkOpenNewTab = linkOpenNewTab;
    let newColor = color;
    ...
    setUrl(newUrl);
    setLinkOpenNewTab(newLinkOpenNewTab);
    setColor(newColor);
  };
  ...
  const onLinkOpenNewTabChange = (value, index) => {
    let newProfiles = [...profiles];
    newProfiles[index].linkOpenNewTab = value;
    setLinkOpenNewTab(value);
    setProfiles(newProfiles);
    onProfileAdd(newProfiles);
  };
  ...
  return (
    <div>
      ...
      <SortableComponent
        ...
        onLinkOpenNewTabChange={onLinkOpenNewTabChange}
        // onSubmit={onSubmit}
