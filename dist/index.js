...
function SeachModal(props) {
  ...
  const handleChange = e => {
    ...
    const {
      ...
      aspectRatio,
      size
    } = filterData; // Case 1 : The user checks the box
...
"use strict";
module.exports = JSON.parse('{"apiVersion":"2","name":"eb-openverse-block/eb-openverse-block","title":"Openverse Block By Essential Blocks","category":"widgets","description":"Easily search & use royalty free images, stock photos, CC-licensed images from Openverse for your website","textdomain":"eb-openverse-block","editorScript":"file:./dist/index.js"}');
